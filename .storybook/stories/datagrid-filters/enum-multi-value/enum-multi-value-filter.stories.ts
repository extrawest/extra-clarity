...
import {
  EcEnumMultiValueFilterComponent,
  EcShowSelected,
...
type Story = StoryObj<EcEnumMultiValueFilterComponent<unknown>>;

const meta: Meta<EcEnumMultiValueFilterComponent<unknown>> = {
  title: 'Components/Datagrid Filters/Enum Multi-Value Filter',
  component: EcEnumMultiValueFilterComponent,
  decorators: [
    applicationConfig({
      providers: [
        provideAnimations(),
