...
<div className="table-of-contents">
  ...
  [Description](#description) * [Configuration](#configuration) * [Default State](#default-state) *
  [Output State](#output-state) * [Read/Write the State](#readwrite-the-state) * [Additional
  Info](#additional-info) - [API](#api) - [Source Code](#source-code)
</div>
...
<ec-string-filter #filterByName>
  ...
  <span>{{ filterByName.state.value }}</span></ec-string-filter
>
```
