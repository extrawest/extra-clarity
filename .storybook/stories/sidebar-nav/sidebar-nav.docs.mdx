...
[icons from the Clarity icon set](https://clarity.design/icons)
...
// <clr-icon shape="envelope" />
```

Please make sure that you have registered all the used shapes in your app
as it's described in the [Clarity icons docs](https://clarity.design/icons):

```typescript
import { ClarityIcons, envelopeIcon } from '@clr/angular';
