...
<div className="table-of-contents">
  ...
  [Description](#description) * [Configuration](#configuration) * [Helpers](#helpers) * [Icons in
  Labels](#icons-in-labels) * [Custom Template](#custom-template) * [Root-level Bold
  Items](#root-level-bold-items) - [API](#api) - [Source Code](#source-code)
</div>
...
```typescript
import { EcSidebarNavComponent } from '@extrawest/extra-clarity/button-copy-to-clipboard';
```
