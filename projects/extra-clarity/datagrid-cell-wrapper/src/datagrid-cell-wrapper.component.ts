...
export class EcDatagridCellWrapperComponent implements OnInit {
   ...
   */
  public readonly btnInline = input(false);
  ...
  public readonly btnWithAnimation = input(true);

  /** Whether to show a border around the button */
  public readonly btnWithBorder = input(false);
